...
ABILITY_EFFECTS: dict[str, dict] = {
    ...
    "dryskin":        {"water_immune": True, "heal": True, "fire_weakness": 1.25},
    "motordrive":     {"electric_immune": True, "speed_boost": 1},
    "eartheater":     {"ground_immune": True, "heal": True},
    "wonderguard":    {"wonder_guard": True},
    ...
    "mindseye":       {"ignore_ghost_immune": True, "ignore_evasion": True},
    "scrappy":        {"ignore_ghost_immune": True},
